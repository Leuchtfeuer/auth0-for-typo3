...
call_user_func(
    function ($extensionKey) {
        ...
        if ($configuration->isEnableBackendLogin()) {
            ...
            $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['backend']['loginProviders'][\Leuchtfeuer\Auth0\LoginProvider\Auth0Provider::LOGIN_PROVIDER] = [
                'provider' => \Leuchtfeuer\Auth0\LoginProvider\Auth0Provider::class,
                'sorting' => 25,
        ...
        \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
            ...
            'bottom',
            [
                \Leuchtfeuer\Auth0\Controller\BackendController::class => 'list',
                \Leuchtfeuer\Auth0\Controller\ApplicationController::class => 'list,delete',
                \Leuchtfeuer\Auth0\Controller\RoleController::class => 'list,update',
                \Leuchtfeuer\Auth0\Controller\PropertyController::class => 'list,new,create,edit,update,delete',
            ], [
                'access' => 'admin',
