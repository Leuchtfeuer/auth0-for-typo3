...
* Constant :php:`AUTH_LOGIN_PROVIDER` of class :php:`\Leuchtfeuer\Auth0\Service\AuthenticationService`
* Following methods of the utility class :php:`\Leuchtfeuer\Auth0\Utility\UserUtility`:
